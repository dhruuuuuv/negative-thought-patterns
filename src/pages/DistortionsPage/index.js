...
const DistortionsPage = ({
  ...
  if (match.params.distortion === 'all-nothing-thinking') {
    return (
      <DistortionPage
        ...
        description={
          `All-or-nothing thinking is where we think, and tend to see the world, only as extremes. People are either good, or bad, we view ourselves as either a complete success or an utter failure.
        ...
        example={
          ...
          You feel as if the answer you gave wasn't reflective of your knowledge.
    ...
    return (
      <DistortionPage
        ...
        help={
          `
          It can be helpful to ask yourself what you're basing the assumption on. Do you have a lot of evidence to back it up?
  ...
  //       description={
  //         `
  //         Here, we assume that something must be true because we feel a certain way, regardless of the evidence of the situation. 
  //         `
  //       }
  //       example={
  //         `
